...
# Hand-built rows. Columns:
# Dataset,Raw_Labels,Kingdom,Phylum,Class,Order,Family,Genus,Species,
# proposed_label,plankton,living,root_class,qualifier,
# wikidata_ID,aphia_ID,NCBI_ID,BOLD_ID,ecotaxa_ID
ROWS = [
    # animalia/cnidaria full depth (plankton True), ds A
    "dsA,raw1,animalia,cnidaria,hydrozoa,siphonophorae,abylidae,abylopsis,tetragona,abylopsis tetragona,True,True,living,full,Q1,1.0,2.0,3.0,10",
    # animalia/cnidaria duplicate (Dataset,Kingdom) transition -> link count 2; ragged (blank Species)
    "dsA,raw2,animalia,cnidaria,hydrozoa,siphonophorae,abylidae,abylopsis,,abylidae,True,True,living,full,Q2,4.0,5.0,6.0,11",
    # animalia/arthropoda (plankton False), ds A
    "dsA,raw3,animalia,arthropoda,copepoda,calanoida,,,,copepod,False,True,living,part,Q3,7.0,8.0,9.0,12",
    # chromista/ochrophyta (plankton True), ds B
    "dsB,raw4,chromista,ochrophyta,bacillariophyceae,,,,,diatom,True,True,living,full,Q4,10.0,11.0,12.0,13",
    # animalia/cnidaria (plankton True), ds B -> shares cnidaria prefix
    "dsB,raw5,animalia,cnidaria,scyphozoa,,,,,jelly,True,True,living,full,Q5,13.0,14.0,15.0,14",
    # fully blank taxonomy below Kingdom (ragged at Phylum), plankton False, ds B
    "dsB,raw6,animalia,,,,,,,unknown,False,False,non-living,none,Q6,16.0,17.0,18.0,15",
]
